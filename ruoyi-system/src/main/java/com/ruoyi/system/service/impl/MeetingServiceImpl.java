...
public class MeetingServiceImpl implements IMeetingService 
{
    ...
    public int insertMeeting(Meeting meeting)
    {
        ...
        // 启动会议流程
        identityService.setAuthenticatedUserId(meeting.getHost());//    设置流程发起人
        HashMap<String, Object> variables = new HashMap<>();      //    设置流程变量
        variables.put("host", meeting.getHost());                 //    会议主持人
        String[] person = meeting.getPeoplelist().split(",");//   参会人员
        variables.put("people", Arrays.asList(person));             //  参会人员
        runtimeService.startProcessInstanceByKey("meeting", String.valueOf(meeting.getId()), variables);//  启动流程
        return row;
    }
