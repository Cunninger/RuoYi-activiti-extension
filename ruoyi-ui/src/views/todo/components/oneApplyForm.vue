<template>
  <div class="c-leaveapply-form">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item v-if="step==='testdeptleadercheck'" label="人事">
      ...
      <el-form-item v-if="step==='testhrcheck'" label="董事长">
        <el-select v-model="form.ceo">
          <el-option
            v-for="(user, i) in userList"
            :key="i"
            :label="user.userName"
      ...
      <template v-if="step==='testdeptleadercheck' || step==='testhrcheck'|| step==='testceocheck'">
...
export default {
  ...
  mounted() {
    listUser().then(res => {
      ...
      // this.form.ceo = this.userList[0] && this.userList[0].userName;
    });
  },
  methods: {
    onSubmit() {
